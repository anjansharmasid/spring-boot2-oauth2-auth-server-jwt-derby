...
/**
 * Once the tables have been created, execute the insert SQL statements in the following order to set up roles, permissions and insert one api user and two application users.
 */
...
INSERT INTO APPUSER ( USERNAME,PASSWORD, EMAIL,ENABLED,ACCOUNT_EXPIRED,CREDENTIALS_EXPIRED,ACCOUNT_LOCKED) 
VALUES 
	('admin','{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi',
    'anjan@gmail.com',1,0,0,0),
    ('user','{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi',
    'asharma@gmail.com',1,0,0,0);
